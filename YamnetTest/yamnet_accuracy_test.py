...
# ESC-50 label → glasses category
ESC50_TO_CATEGORY = {
    # door / entry
    "door_wood_knock":   "door_entry",
    "door_wood_creaks":  "door_entry",
    # animals
    "dog":               "animal",
    "cat":               "animal",
    "rooster":           "animal",
    ...
    "vacuum_cleaner":    "appliance",
    "clock_tick":        "appliance",
    "can_opening":       "appliance",
    "keyboard_typing":   "appliance",
    "mouse_click":       "appliance",
    "toilet_flush":      "appliance",
    # speech / human
    "crying_baby":       "speech",
    "laughing":          "speech",
    "coughing":          "speech",
